...
export default function Home() {
  ...
  return <main>
    ...
    <section className="contact" id="contact"><div className="contact-orbit orbit-one" /><div className="contact-orbit orbit-two" /><div className="contact-content" data-reveal><p className="kicker">OPEN CHANNEL</p><h2>LET&apos;S MAP<br /><em>WHAT&apos;S NEXT.</em></h2><p>Have a spatial idea, a backend challenge, or just want to talk maps and software? I&apos;d like to hear from you.</p><div className="contact-links"><a href="mailto:earth.phurinat@gmail.com">EMAIL <span>earth.phurinat@gmail.com ↗</span></a><a href="https://github.com/Xeei" target="_blank" rel="noreferrer">GITHUB <span>github.com/Xeei ↗</span></a></div><small>OPEN TO COLLABORATION — EMAIL OR GITHUB</small></div><footer><span>© 2026 PHURINAT KHRUEATAN</span><a href="#top">BACK TO TOP ↑</a></footer></section>
  </main>;
}
